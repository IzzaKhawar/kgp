    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254)),
                ('password', models.CharField(max_length=500)),
                ('department_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facultyapp.department')),
            ],
        ),
        migrations.CreateModel(
            name='SignUp',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facultyapp.signup')),
            ],
        ),
        migrations.CreateModel(
            name='LoginActivity',
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='signup', to='facultyapp.signup')),
            ],
        ),
        migrations.CreateModel(
            name='HODSignUpEmail',
            fields=[
                ...
                ('hod_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facultyapp.hodsignup')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.BooleanField(default=False)),
                ('faculty_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facultyapp.facultysignup')),
            ],
        ),
        migrations.AddField(
            model_name='facultysignup',
            name='hod_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facultyapp.hodsignup'),
        ),
        migrations.CreateModel(
            name='Complaint',
            fields=[
                ...
                ('complaint_category_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facultyapp.complaintcategory')),
                ('department_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facultyapp.department')),
                ('faculty_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='facultyapp.facultysignup')),
                ('hod_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facultyapp.hodsignup')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facultyapp.signup')),
            ],
        ),
